...
params = {'lasso__alpha': np.linspace(0.1,20.1,50),
          'ridge__alpha': np.linspace(0,15,50),
...
predict.to_csv('stack_grid2019-03-04.csv', index=False)

 pickle.dump(grid, open('grid.sav', 'wb'))
